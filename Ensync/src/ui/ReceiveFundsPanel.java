...
public class ReceiveFundsPanel extends JPanel {
    ...
    private ImageIcon generateQRCode(String s, String charset){
        ...
        try{
            ...
            MatrixToImageWriter.writeToPath(matrix, "png", new File("data/temp_wallet_data/qrcode.png").toPath());
        }
        catch(WriterException | IOException e){
            return new ImageIcon("images/other/qrcode_error_icon.png");
        }
        return new ImageIcon("data/temp_wallet_data/qrcode.png");
    }
